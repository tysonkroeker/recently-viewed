...
* **view** - An alternate product view to use for requesting product JSON data.  By default this will use @/products/[product-handle].js@, but if set to 'json' (for example) will use @/products/[product-handle]?view=json@.  Optional.
